...
The fslr package is an interface to the FSL (FMRIB Software Library) tools. Install it from CRAN:
...
If you want the package to resolve the EVE template automatically, install the optional `EveTemplate` package. Otherwise, you can supply a template path directly to `eve_T1()`, `eve_Fl()`, and `map2_eve()`.
