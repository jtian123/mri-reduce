...
The
[`map2_eve()`](https://uscbiostats.github.io/MRIreduce/reference/map2_eve.md)
helper also requires a working Python environment for `reticulate` with
the Python packages `nilearn`, `nibabel`, and `matplotlib`. This is only
needed if you want to generate EVE-overlay figures from R.
...
- [`eve_T1()`](https://uscbiostats.github.io/MRIreduce/reference/eve_T1.md)
  ...
  require FSL.
- [`map2_eve()`](https://uscbiostats.github.io/MRIreduce/reference/map2_eve.md)
  requires Python packages configured for `reticulate`.
