...
#'
#' @details The function uses FSL tools for image processing steps such as reorientation to standard space,
#' bias correction, brain extraction, and tissue segmentation.
...
#' @importFrom fslr fslreorient2std fsl_biascorrect fslbet fast fslstats flirt
#' @importFrom oro.nifti img_data voxres
#' @export

eve_Fl <- function(fpath, outpath, fsl_path, fsl_outputtype = "NIFTI_GZ", template_img_path = NULL) {
  ...
  bc_fl = fsl_biascorrect(file = fl_ro)
